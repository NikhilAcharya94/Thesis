...
minutes_entity= "http://www.semanticweb.org/nikhil/ontologies/right/Itunes-Ontology#"+"Minute"
seconds_entity= "http://www.semanticweb.org/nikhil/ontologies/right/Itunes-Ontology#"+"Seconds"
Time_class= "http://www.semanticweb.org/nikhil/ontologies/right/Itunes-Ontology#"+"Time"
duration_class="http://www.semanticweb.org/nikhil/ontologies/right/Itunes-Ontology#"+"Duration"

def string_acronym_populate(artist_name_uri,artist_alias_uri):
    for alias in artist_alias_uri:
        query_v="PREFIX ITUNES: <http://www.semanticweb.org/nikhil/ontologies/right/Itunes-Ontology#>  SELECT ?song WHERE { <"+alias+"> ITUNES:Sang ?song.}"
...
def resolve_conversion_rate():
    ...
    """ PREFIX ITUNES: <http://www.semanticweb.org/nikhil/ontologies/right/Itunes-Ontology#> 
...
def main():      
    ...
    g.parse ('output_file_result_right.ttl', format='ttl')
    ...
    g.serialize('output_file_right_conflicts.ttl',format='ttl')        